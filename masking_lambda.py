...
def static_mask(nx=516,ny=1556,npadsx=2,npadsy=6,bordersize=8,padspacing = 8):
    ...
    bordersize: how many pixels to mask from the edges
    padspacing: how many pixels to mask between pads
...
def circular_mask(nx=516,ny=1556,center_x=277,center_y=725,radius=30):
    '''
